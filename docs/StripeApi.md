# better_auth.StripeApi

All URIs are relative to *http://localhost:3000/api/auth*

Method | HTTP request | Description
------------- | ------------- | -------------
[**handle_stripe_webhook**](StripeApi.md#handle_stripe_webhook) | **POST** /stripe/webhook | 
...
with better_auth.ApiClient(configuration) as api_client:
    ...
    api_instance = better_auth.StripeApi(api_client)

    try:
        api_instance.handle_stripe_webhook()
    except Exception as e:
        print("Exception when calling StripeApi->handle_stripe_webhook: %s\n" % e)
```
